...
const firebaseConfig = {
  apiKey: process.env.VITE_FIREBASE_API_KEY || "AIzaSyAvdOyBT1Zk9rZ79nP2vdhpfpIQjGfw8Q",
  authDomain: process.env.VITE_FIREBASE_AUTH_DOMAIN || "chat-4c3a7.firebaseapp.com",
  projectId: process.env.VITE_FIREBASE_PROJECT_ID || "chat-4c3a7",
  storageBucket: process.env.VITE_FIREBASE_STORAGE_BUCKET || "chat-4c3a7.firebaseapp.com",
  messagingSenderId: process.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "995636644973",
  appId: process.env.VITE_FIREBASE_APP_ID || "1:995636644973:web:59554144cbaad5d1444364",
  measurementId: process.env.VITE_FIREBASE_MEASUREMENT_ID || "G-9T5TLP4SF1"
};
